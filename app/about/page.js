      ...
      <div className="relative bg-orange-500">
        ...
        <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
          ...
          <p className="mt-6 text-xl text-orange-100 max-w-3xl">
            We are on a mission to transform the way people think about food delivery. With FoodHub, you get the best of local cuisine delivered right to your doorstep.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
            {stats.map((stat) => (
              <div
                key={stat.label}
                className="bg-white rounded-lg shadow px-4 py-5 sm:p-6 text-center"
              >
